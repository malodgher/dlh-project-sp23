...
lab_events_df = lab_events_df.loc[:labevents_records, :]
lab_events_df.head()
...
#input_limited_df = input_onehot_df
...
#model.add(GRU(units=1, input_shape=(seq_length, num_features)))
